...
public class CourseItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof CharacterItemHolderInfo) {
            ...
            CourseAdapter.CourseViewHolder holder = (CourseAdapter.CourseViewHolder) newHolder;

            if (CourseAdapter.ACTION_LIKE_IMAGE_DOUBLE_CLICKED.equals(recipesItemHolderInfo.updateAction)) {
    ...
    private void animatePhotoLike(final CourseAdapter.CourseViewHolder holder) {
