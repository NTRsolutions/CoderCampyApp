...
public class InstructorItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof CharacterItemHolderInfo) {
            ...
            InstructorAdapter.InstructorViewHolder holder = (InstructorAdapter.InstructorViewHolder) newHolder;

            if (InstructorAdapter.ACTION_LIKE_IMAGE_DOUBLE_CLICKED.equals(recipesItemHolderInfo.updateAction)) {
    ...
    private void animatePhotoLike(final InstructorAdapter.InstructorViewHolder holder) {
